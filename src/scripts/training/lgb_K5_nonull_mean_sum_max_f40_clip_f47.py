"""
LGB,KF5,non-null,mean,sum,max,f40,clip f47
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,clip f47"
...
combined_df["f47"] = process_data.remove_normal_outlier(
    feature_name="f47", source_df=combined_df, target_df=combined_df
)
