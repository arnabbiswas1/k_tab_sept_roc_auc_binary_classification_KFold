"""
LGB, KFold-5, not filled, bin qcut
"""
...
SEED = 42
EXP_DETAILS = "LGB, KFold-5, not filled, bin qcut"
...
logger.info("Adding features related to bin cut")
features_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/features_bin_qcut.parquet")
