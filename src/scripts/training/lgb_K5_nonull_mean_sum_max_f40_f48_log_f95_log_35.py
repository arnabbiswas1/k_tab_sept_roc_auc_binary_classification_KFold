"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f35 cube root"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f35 cube root"
...
combined_df["f35_cbrt"] = np.cbrt(combined_df["f35"])
