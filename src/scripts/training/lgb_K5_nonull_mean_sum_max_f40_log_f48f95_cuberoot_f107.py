"""
"LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,cuberoot:f107 - f107"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,cuberoot:f107 - f107"
...
combined_df["f107_cr"] = np.cbrt(combined_df["f107"])

features_to_drop = ["f107"]
