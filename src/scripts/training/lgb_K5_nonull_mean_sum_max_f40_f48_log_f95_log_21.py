"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,logf21"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,logf21"
...
combined_df["f21_cbrt"] = np.cbrt(combined_df["f21"])
