"""
"LGB,KF5,non-null,mean,sum,max,f40,f48 log + f48, f95 cuberoot"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,f48 log + f48, f95 cuberoot"
...
combined_df["f95_cbrt"] = np.cbrt(combined_df["f95"])
