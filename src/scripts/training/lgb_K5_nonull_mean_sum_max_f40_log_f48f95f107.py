"""
"LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,f107"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,f107"
...
combined_df["f107_log"] = np.log1p(
    combined_df["f107"].clip(lower=0, upper=combined_df["f107"].max())
)
