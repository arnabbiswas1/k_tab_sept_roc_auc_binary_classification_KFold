"""
LGB,SK10,non-null,mean,sum,max,f40,48,95,3,mean impute,no-scaler,log_loss
...
SEED = 2021
EXP_DETAILS = "LGB,SK10,non-null,mean,sum,max,f40,48,95,3,mean impute,no-scaler,log_loss"
