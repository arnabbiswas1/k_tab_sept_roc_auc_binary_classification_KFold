"""
LGB benchmark KFold-5 non-null percentage
"""
...
SEED = 42
EXP_DETAILS = "LGB benchmark KFold-5 non-null percentage"
...
combined_df["no_null_percent"] = combined_df.isna().sum(axis=1)/len(combined_df.columns)
