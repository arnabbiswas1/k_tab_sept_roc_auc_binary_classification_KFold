"""
LGB, KFold-5, fillna ploynomial 3
"""
...
SEED = 42
EXP_DETAILS = "LGB, KFold-5, fillna ploynomial 3"
...
filled_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/imputed_data_w_pol_3.parquet")

# combined_df = pd.concat([train_df.drop(TARGET, axis=1), test_df])
target = train_df[TARGET]

train_df = filled_df.loc[train_df.index]
train_df[TARGET] = target

test_df = filled_df.loc[test_df.index]
