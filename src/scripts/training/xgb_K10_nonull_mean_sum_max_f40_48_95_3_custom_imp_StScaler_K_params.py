"""
"XGB,K10,Custom Imputer,Standard Scaler,no null,mean,sum,max,f40,48,95,3,params from K"
...
combined_df[predictors] = combined_df[predictors].fillna(
    combined_df.groupby("no_null")[predictors].transform("mean")
)
