"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f78log"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f78log"
...
combined_df["f78_log"] = np.log1p(
    combined_df["f78"].clip(lower=0, upper=combined_df["f78"].max())
)
