"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,cbrtf3,logf77"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,cbrtf3,logf77"
...
combined_df["f77_cbrt"] = np.cbrt(combined_df["f77"])
