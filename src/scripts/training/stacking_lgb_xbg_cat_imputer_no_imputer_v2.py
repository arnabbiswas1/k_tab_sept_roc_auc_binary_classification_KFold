"""
"Stacking: LGB, XGB, Cat with and without imputation old/new LGBs/XGB/Cat,tsne,LR,mean/median LGB/XGB/cat,all LGB, MLP"
"""
...
SEED = 42
EXP_DETAILS = "Stacking: LGB, XGB, Cat with and without imputation old/new LGBs/XGB/Cat,tsne,LR,mean/median LGB/XGB/cat,all LGB, MLP, NB"
IS_TEST = False
...
# Cat Mean/Median
sub_20_predition_name = "sub_cat_K10_nonull_mean_sum_max_f40_48_95_3_mean_medain_RobScaler_K_params_0930_1242_0.81604.gz"
sub_20_oof_name = "oof_cat_K10_nonull_mean_sum_max_f40_48_95_3_mean_medain_RobScaler_K_params_0930_1242_0.81604.csv"

sub_20_test_pred = pd.read_csv(f"{constants.SUBMISSION_DIR}/{sub_20_predition_name}")
sub_20_oof_pred = pd.read_csv(f"{constants.OOF_DIR}/{sub_20_oof_name}")
logger.info(
    f"Shape of submission and oof file {sub_20_test_pred.shape}, {sub_20_oof_pred.shape}")

# NB
sub_21_predition_name = "sub_NB_nonull_mean_sum_max_f40_48_95_3_no_imp_no_scaler_K_params_0930_1429_0.78541.gz"
sub_21_oof_name = "oof_NB_nonull_mean_sum_max_f40_48_95_3_no_imp_no_scaler_K_params_0930_1429_0.78541.csv"

sub_21_test_pred = pd.read_csv(f"{constants.SUBMISSION_DIR}/{sub_21_predition_name}")
sub_21_oof_pred = pd.read_csv(f"{constants.OOF_DIR}/{sub_21_oof_name}")
logger.info(
    f"Shape of submission and oof file {sub_21_test_pred.shape}, {sub_21_oof_pred.shape}")

# MLP
sub_22_predition_name = "sub_MLP_nonull_mean_sum_max_f40_48_95_3_no_imp_no_scaler_K_params_0930_1521_0.80525.gz"
sub_22_oof_name = "oof_MLP_nonull_mean_sum_max_f40_48_95_3_no_imp_no_scaler_K_params_0930_1521_0.80525.csv"

sub_22_test_pred = pd.read_csv(f"{constants.SUBMISSION_DIR}/{sub_22_predition_name}")
sub_22_oof_pred = pd.read_csv(f"{constants.OOF_DIR}/{sub_22_oof_name}")
logger.info(
    f"Shape of submission and oof file {sub_22_test_pred.shape}, {sub_22_oof_pred.shape}")
