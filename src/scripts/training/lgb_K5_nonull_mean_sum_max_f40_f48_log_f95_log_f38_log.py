"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f38log"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f38log"
...
combined_df["f38"] = np.log1p(combined_df["f38"])
