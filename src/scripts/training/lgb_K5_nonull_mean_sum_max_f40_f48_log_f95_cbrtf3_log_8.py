"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,cbrtf3,cbrtf8"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,cbrtf3,cbrtf8"
...
combined_df["f8_cbrt"] = np.cbrt(combined_df["f8"])
