"""
"LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f19 cuberoot"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,logf48,logf95,f19 cuberoot"
...
# combined_df["f19_log"] = np.log1p(
#     combined_df["f19"].clip(lower=0, upper=combined_df["f19"].max())
# )

combined_df["f19_cbrt"] = np.cbrt(combined_df["f19"])

# features_to_drop = ["f95"]
