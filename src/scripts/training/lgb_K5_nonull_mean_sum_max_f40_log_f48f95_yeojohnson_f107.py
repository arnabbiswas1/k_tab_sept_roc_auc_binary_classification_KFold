"""
"LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,yeojohson:f107"
"""
...
SEED = 42
EXP_DETAILS = "LGB,KF5,non-null,mean,sum,max,f40,log:f48,f95,yeojohson:f107"
...
combined_df["f107_sym"], fitted_lambda = stats.yeojohnson(combined_df["f107"])
