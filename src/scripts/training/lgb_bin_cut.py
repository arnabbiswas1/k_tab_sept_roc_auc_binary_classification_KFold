"""
LGB, KFold-5, not filled, bin cut
"""
...
SEED = 42
EXP_DETAILS = "LGB, KFold-5, not filled, bin cut"
...
features_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/features_bin_cut.parquet")
