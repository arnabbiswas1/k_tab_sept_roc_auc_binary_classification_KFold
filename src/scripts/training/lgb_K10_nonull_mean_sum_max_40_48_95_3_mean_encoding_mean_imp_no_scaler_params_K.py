"""
LGB,K10,non-null,mean,sum,max,f40,48,95,3,mean encoding,mean impute,no-scaler
...
SEED = 2021
EXP_DETAILS = "LGB,K10,non-null,mean,sum,max,f40,48,95,3,mean encoding,mean impute,no-scaler"
