"""
LGB,K10,non-null,full data,mean,sum,max,params from k
params: https://www.kaggle.com/ivankontic/004-2o-lightgbm-colsample-tps-sep-2021
"""
...
SEED = 37
EXP_DETAILS = "LGB,K10,non-null,full data,mean,sum,max,params from k"
