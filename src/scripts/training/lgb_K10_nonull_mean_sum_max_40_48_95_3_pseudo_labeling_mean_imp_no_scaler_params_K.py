"""
LGB,K10,non-null,mean,sum,max,f40,48,95,3,pseudo labeling,mean encoding,mean impute,no-scaler
...
SEED = 2021
EXP_DETAILS = "LGB,K10,non-null,mean,sum,max,f40,48,95,3,pseudo labeling,mean encoding,mean impute,no-scaler"
...
test_2_df.loc[test_2_df[TARGET] >= 0.5, TARGET] = 1
test_2_df.loc[test_2_df[TARGET] < 0.5, TARGET] = 0
