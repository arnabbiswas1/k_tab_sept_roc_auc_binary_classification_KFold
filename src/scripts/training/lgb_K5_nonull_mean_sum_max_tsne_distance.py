"""
"LGB,K5,non-null,mean,sum,max,tsne,distance_tsne"
"""
...
SEED = 42
EXP_DETAILS = "LGB,K5,non-null,mean,sum,max,tsne,distance_tsne"
...
combined_clustering = combined_clustering[["t_sne_0", "t_sne_1", "distance_tsne"]]
