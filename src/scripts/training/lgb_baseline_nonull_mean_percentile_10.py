"""
LGB benchmark KFold-5, non-null, mean, percentile_10
"""
...
SEED = 42
EXP_DETAILS = "LGB benchmark KFold-5, non-null, mean, percentile_10"
...
features_to_use = ["no_null", "mean", "percentile_10"]
