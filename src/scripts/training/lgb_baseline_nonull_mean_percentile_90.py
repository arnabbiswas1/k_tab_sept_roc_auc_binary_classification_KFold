"""
LGB benchmark KFold-5, non-null, mean, percentile_90
"""
...
SEED = 42
EXP_DETAILS = "LGB benchmark KFold-5, non-null, mean, percentile_90"
...
features_to_use = ["no_null", "mean", "percentile_90"]
