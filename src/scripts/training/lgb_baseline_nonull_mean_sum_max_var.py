"""
LGB benchmark KFold-5, non-null, mean, sum, max, var
"""
...
SEED = 42
EXP_DETAILS = "LGB benchmark KFold-5, non-null, mean, sum, max, var"
...
features_df["var"] = features_df["std"].pow(2)
features_to_use = ["no_null", "mean", "sum", "max", "var"]
