"""
"LR,K10,no imputer,no scaler,no null,mean,sum,max,f40,48,95,3,params from K"
...
sklearn_model = LogisticRegression(n_jobs=-1, C=0.01, penalty="l2", random_state=SEED)
