...
if __name__ == "__main__":
    ...
    # https://www.kaggle.com/takahiroyoshida012/smart-ensembling-tps-aug-2021-7-84986
    # PL :7.84986
    df_2 = pd.read_csv(
        f"{constants.PUB_SUBMISSION_DIR}/submission_7.84986.csv"
    )
    ...
    sample_submission_df.loss = (
        0.40 * df_sub_ext.loss + 0.59 * df_2.loss + 0.01 * df_lgb_log_loss_top_10.loss
    ).values
