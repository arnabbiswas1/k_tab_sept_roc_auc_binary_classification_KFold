"""
LGB ts log_loss SKFold 10 cwt_coeff_set
"""
...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "LGB ts log_loss SKFold 10 cwt_coeff_set"
    IS_TEST = False
    ...
    features_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/cast/cwt_coeff_set_cast.parquet")
