...
if __name__ == "__main__":
    ...
    # LGB, Kaggle param, no freq, seed 20, KFold, objective: poisson
    df_3 = pd.read_csv(
        f"{constants.SUBMISSION_DIR}/sub_lgb_SKF_freq_params_f_kaggle_poisson_0817_1303_7.84101.csv"
    )

    # Giving more importnace to external submission
    sample_submission_df.loss = (
        0.99 * df_sub_ext.loss + 0.01 * df_3.loss
    ).values
