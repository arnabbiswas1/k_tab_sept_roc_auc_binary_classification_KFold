...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "LGB ts roc auc 0 & 1 target"
    IS_TEST = False
    ...
    # Converting loss to binary
    logger.info("Converting loss to binary..")
    train_df["loss"] = np.where(train_df["loss"] > 0, 1, 0)
