"""
LGB ts log_loss SKFold 10 mixed 3
"""
...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "LGB ts log_loss SKFold 10 mixed 3"
    IS_TEST = False
    ...
    features_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/cast/mixed_3_set_cast.parquet")
