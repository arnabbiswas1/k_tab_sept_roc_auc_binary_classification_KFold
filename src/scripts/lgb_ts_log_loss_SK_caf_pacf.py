"""
LGB ts log_loss SKFold 10 acf, pacf
"""
...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "LGB ts log_loss SKFold 10 acf, pacf"
    IS_TEST = False
    ...
    features_df = pd.read_parquet(f"{constants.FEATURES_DATA_DIR}/cast/acf_pacf_set_cast.parquet")
