"""
XGB with SK(10) cut bin (10) all 100 features
"""
...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "XGB with SK(10) cut bin (10) all 100 features"
    IS_TEST = False
    ...
    feature_names = process_data.get_bin_feature_names(combined_df)

    logger.info(f"Selceting bin(10) features {feature_names}")
