"""
XGB ts f1-weighted SKFold 5 top all features
"""
...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "XGB ts f1-weighted SKFold 5 all features"
    IS_TEST = False
    ...
    common.update_tracking(RUN_ID, "metric", METRIC)
    ...
    results_dict = model.xgb_train_validate_on_cv(
        ...
        verbose_eval=100,
        is_test=IS_TEST,
        feval=model.evaluate_macroF1_xgb,
    )
