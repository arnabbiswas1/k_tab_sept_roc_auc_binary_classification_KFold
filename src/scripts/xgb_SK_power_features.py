...
if __name__ == "__main__":
    ...
    SEED = 42
    EXP_DETAILS = "XGB with SK(10) power features"
    IS_TEST = False
    ...
    feature_names = process_data.get_power_feature_names(combined_df)

    logger.info(f"Selceting power features {feature_names}")
